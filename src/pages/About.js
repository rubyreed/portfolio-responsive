    ...
    return (
        <Container style={{display:"flex", justifyContent:"center", height: "100%"}}>
            <div style={{display: "flex", flexDirection: "column", alignItems: "center", marginRight: "4rem", maxWidth:"60rem", marginBottom:"5rem"}}>
                <img style={{height:"25rem", width:"25rem", objectFit:"cover", borderRadius:"12.5rem", marginTop:"5rem", marginBottom:"1rem", boxShadow: "rgba(0, 0, 0, 0.2) 0px 12px 28px 0px, rgba(0, 0, 0, 0.1) 0px 2px 4px 0px, rgba(255, 255, 255, 0.05) 0px 0px 0px 1px inset"}} src={ruby} alt="ruby"/>
                <div style={{display:"flex", flexDirection:"row", justifyContent:"center"}}>
                <a href = "https://github.com/rubyreed" target="_blank"><img style={{height:"3rem", padding:"1rem"}} src={githubwhite}/></a>
                <a href = "https://www.linkedin.com/in/ruby-s-reed/" target="_blank"><img style={{height:"3rem", padding:"1rem"}} src={linkedinwhite}/></a>
                <Nav onSelect={handleSelect}>
                    <Nav.Link eventKey="/contact">
                        <img style={{height:"3rem", padding:"1rem"}} src={contactwhite}/>
                    </Nav.Link>
                </Nav>
                </div>
                ...
                <LightButton style={{width:"15rem", marginTop:"5rem"}}>View My Resume</LightButton>
                </form>
